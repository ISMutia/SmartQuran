...
$('.tanggal .masehi').text(`${MasehiDays[masehiDay]}, ${masehiDate} ${MasehiMonths[masehiMonth - 1]} ${MasehiYears[masehiYear]} 2021`)
...
$('.tanggal-wrapper .prev-date').on('click', function () {
   ...
   $('.tanggal .masehi').text(`${MasehiDays[changedMasehiDay]}, ${changedMasehiDate} ${MasehiMonths[changedMasehiMonth]} ${MasehiYears[changedMasehiYear]}`)
